# The VK-5 surface bridge record, macOS
...
> the one above, because the VK-5 section is what this record is retained for.

This is the native evidence for issue #216: the same proof run as the VK-2
records, now carrying VK-5's session, whose section is headed "VK-5: the
loader-aware GLFW surface bridge" below. It ran locally on an Apple M3 Max under MoltenVK, with the human's explicit approval for that one session, against a native prefix `tools/native/native.py build` provisioned from the pinned recipe into a scratch directory, because the shared prefix predated a Command Line Tools update and `prepare` refused it. The prefix path therefore appears in the captured transcript; the identities it recorded are the pinned ones.

It was produced from repository revision `076ce59b9460bce5236f1ded8ccbdd3c91073d41` and source digest
`00984d93cbc6a274f7a36ca67fbcaaa8233d00c3729170cf6b0d20dbc327f973`, the same pair the other platform's VK-5 record carries; the digest
covers the GLFW package, whose Vulkan interop component and surface bridge this
session exercises, the runtime, the native backend and diagnostics packages and
their local closure as well as the harness. It identifies the tree the run was
produced from, not this file's commit.

What the VK-5 section shows, on this platform:

- the capability `allocLoaderIntegration` built is the binding's own
  `vkGetInstanceProcAddr`, at the same address in the same loader image; while
  the loader-aware session was live the production shim held that address and
  GLFW resolved `vkGetInstanceProcAddr` to it, and GLFW and the binding resolved
  `vkCreateDevice` for the created instance into the same image;
- the session copied the platform's required instance extensions
  (`VK_KHR_surface`, `VK_EXT_metal_surface`), and the instance was created with them;
- a surface was created inside a protected attachment's construction step for
  the host's hidden window, and the binding answered a presentation-support
  query about it;
- while it was owed, the attachment's `DependentsDisposed` fact was refused and
  the instance's release was retained; once another OS thread had destroyed it
  through the obligation, the fact retired the attachment and the instance was
  releasable;
- after the session terminated the shim held null and the capability was
  restored;
- the reset after a failed initialization is not reachable here: GLFW 3.4's
  Cocoa initialization has no failure an application can provoke, and Cocoa is
  the only backend macOS admits, so that example is pending in this record. It
  is observed natively in the Linux record and held headlessly by the seam
  example `restores the default after a failed initialization`.
...
HETOIMASIA_NATIVE_SESSION=desktop \
  VK_DRIVER_FILES=/private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vulkan/icd.d/MoltenVK_icd.json \
  VK_LAYER_PATH=/private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vulkan/explicit_layer.d \
  vulkan-proof
```

## The environment

- source digest: 00984d93cbc6a274f7a36ca67fbcaaa8233d00c3729170cf6b0d20dbc327f973
- repository revision: 076ce59b9460bce5236f1ded8ccbdd3c91073d41
...
- the binding's vkGetInstanceProcAddr: 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
- GLFW's vkGetInstanceProcAddr: 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
- the binding's vkCreateDevice: 0x00000001077d103c in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkCreateDevice
- GLFW's vkCreateDevice: 0x00000001077d103c in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkCreateDevice
- a device-level entry point: 0x000000011e124d78 in /usr/local/lib/libVkLayer_khronos_validation.dylib as _ZN20vulkan_layer_chassis12QueueSubmit2EP9VkQueue_TjPK13VkSubmitInfo2P9VkFence_T
- device: Apple M3 Max
...
- device: Apple M3 Max
- messenger callback: 0x0000000100accf2c in /Users/vincentcoghlan/worktrees/coghex/hetoimasia/issue-216-glfw-surface-bridge/dist-vulkan-proof/build/aarch64-osx/ghc-9.14.1/hetoimasia-vulkan-proof-0.1.0.0/t/vulkan-proof/opt/build/vulkan-proof/vulkan-proof as hetoimasia_vulkan_capture_messenger
- this executable: /Users/vincentcoghlan/worktrees/coghex/hetoimasia/issue-216-glfw-surface-bridge/dist-vulkan-proof/build/aarch64-osx/ghc-9.14.1/hetoimasia-vulkan-proof-0.1.0.0/t/vulkan-proof/opt/build/vulkan-proof/vulkan-proof
...
| vkCreateInstance | info | Loader Message |       /Users/vincentcoghlan/worktrees/coghex/hetoimasia/issue-216-glfw-surface-bridge/dist-vulkan-proof/build/aarch64-osx/ghc-9.14.1/hetoimasia-vulkan-proof-... |
...
| vkCreateInstance | info | Loader Message |    In following locations: |
| vkCreateInstance | info | Loader Message |       /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vulkan/explicit_... |
| vkCreateInstance | info | Loader Message |    Found the following files: |
| vkCreateInstance | info | Loader Message |       /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vulkan/explicit_... |
| vkCreateInstance | info | Loader Message | Found manifest file /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vu... |
| vkCreateInstance | info | Loader Message | Searching for driver manifest files |
| vkCreateInstance | info | Loader Message |    In following locations: |
| vkCreateInstance | info | Loader Message |       /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vulkan/icd.d/Mol... |
| vkCreateInstance | info | Loader Message |    Found the following files: |
| vkCreateInstance | info | Loader Message |       /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vulkan/icd.d/Mol... |
| vkCreateInstance | info | Loader Message | Found ICD manifest file /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/shar... |
...
| vkCreateInstance | info | Loader Message |            Manifest: /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/v... |
...
| vkCreateInstance | info | WARNING-CreateInstance-status-message | Validation Information: [ WARNING-CreateInstance-status-message ] Object 0: handle = 0xb94e47000, type = VK_OBJECT_TYPE_INSTANCE; \| MessageID = 0x23dfd876 \| ... |
...
| vkCreateDevice | info | Loader Message |            Manifest: /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/v... |
...
| vkDestroyInstance, after the explicit messenger was destroyed | info | mvk-info | Destroyed VkPhysicalDevice for GPU Apple M3 Max with 4 MB of GPU memory still allocated. |
...
- binding vkGetInstanceProcAddr: 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
- capability made from: 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
- shim setting while the session was live: 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
- GLFW resolved vkGetInstanceProcAddr to: 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
- capability while the session was live: IntegrationInstalled
- binding vkCreateDevice: 0x00000001077d103c in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkCreateDevice
- GLFW vkCreateDevice: 0x00000001077d103c in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkCreateDevice
- required instance extensions, as copied: VK_KHR_surface, VK_EXT_metal_surface
- surface creation: SurfaceCreated (WindowSurface (SurfaceObligation (AttachmentId (WindowId 1) 1) 49747381040))
- surface handle: 49747381040
...
## The environment
implicit-layer policy: VK_LOADER_LAYERS_DISABLE=~implicit~, so no implicit layer joins the chain and the explicit layers below are all of it
proving repository revision 076ce59b9460bce5236f1ded8ccbdd3c91073d41
proving source digest 00984d93cbc6a274f7a36ca67fbcaaa8233d00c3729170cf6b0d20dbc327f973
VK_DRIVER_FILES = /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vulkan/icd.d/MoltenVK_icd.json
VK_LAYER_PATH = /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/share/vulkan/explicit_layer.d
## The shared loader
the binding dispatches through 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
the binding's loader is the recorded loader /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib
GLFW resolves the same name to 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
GLFW requires VK_KHR_surface, VK_EXT_metal_surface
## The instance
the loader reports instance version 1.3.296
the binding resolves vkCreateDevice to 0x00000001077d103c in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkCreateDevice
GLFW resolves vkCreateDevice to 0x00000001077d103c in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkCreateDevice
## The window and its surface
## The device profile
Apple M3 Max advertises Vulkan 1.3.323
selected Apple M3 Max, advertising Vulkan 1.3.323
the binding dispatches image release through 0x000000011e159b64 in /usr/local/lib/libVkLayer_khronos_validation.dylib as _ZN20vulkan_layer_chassis25ReleaseSwapchainImagesEXTEP10VkDevice_TPK31VkReleaseSwapchainImagesInfoEXT
...
## VK-6: C-only validation capture
the messenger callback is hetoimasia_vulkan_capture_messenger in /Users/vincentcoghlan/worktrees/coghex/hetoimasia/issue-216-glfw-surface-bridge/dist-vulkan-proof/build/aarch64-osx/ghc-9.14.1/hetoimasia-vulkan-proof-0.1.0.0/t/vulkan-proof/opt/build/vulkan-proof/vulkan-proof
...
the capability was made from 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
while the session is live the shim holds 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
GLFW resolves vkGetInstanceProcAddr to 0x00000001077cf8f4 in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkGetInstanceProcAddr
the session copied the required extensions VK_KHR_surface, VK_EXT_metal_surface
the binding resolves vkCreateDevice to 0x00000001077d103c in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkCreateDevice
GLFW resolves vkCreateDevice to 0x00000001077d103c in /private/tmp/claude-501/-Users-vincentcoghlan-work-hetoimasia/a508753d-e483-4251-bcf8-cbe69062198b/scratchpad/native/glfw/vulkan/lib/libvulkan.1.dylib as vkCreateDevice
created surface 49747381040 for the attached window
