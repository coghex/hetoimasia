...
`vulkan-proof` route of `.github/workflows/ci-image.yml` (run 36029605699),
...
It was produced from repository revision `6396e9b8622122269b25dd4a04df7559ae6dca77`
and source digest
`f8c081769f9fc23d46216432173c579bdccaad6d0ed516d04401665ba2c6ea99`; the digest
...
- source digest: f8c081769f9fc23d46216432173c579bdccaad6d0ed516d04401665ba2c6ea99
- repository revision: 6396e9b8622122269b25dd4a04df7559ae6dca77
...
- the binding's vkGetInstanceProcAddr: 0x00007f8caf1663d0 in /lib/x86_64-linux-gnu/libvulkan.so.1 as vkGetInstanceProcAddr
- GLFW's vkGetInstanceProcAddr: 0x00007f8caf1663d0 in /lib/x86_64-linux-gnu/libvulkan.so.1 as vkGetInstanceProcAddr
- the binding's vkCreateDevice: 0x00007f8caf166090 in /lib/x86_64-linux-gnu/libvulkan.so.1 as vkCreateDevice
- GLFW's vkCreateDevice: 0x00007f8caf166090 in /lib/x86_64-linux-gnu/libvulkan.so.1 as vkCreateDevice
- a device-level entry point: 0x00007f8c8a3ab850 in /usr/lib/x86_64-linux-gnu/libVkLayer_khronos_validation.so
...
- device: llvmpipe (LLVM 20.1.2, 256 bits)
- messenger callback: 0x00000000006f8de0 in /candidate/dist-vulkan-proof/build/x86_64-linux/ghc-9.14.1/hetoimasia-vulkan-proof-0.1.0.0/t/vulkan-proof/opt/build/vulkan-proof/vulkan-proof
...
| vkCreateInstance | info | WARNING-CreateInstance-status-message | Validation Information: [ WARNING-CreateInstance-status-message ] Object 0: handle = 0x16ceab60, type = VK_OBJECT_TYPE_INSTANCE; \| MessageID = 0x23dfd876 \| v... |
...
- binding vkGetInstanceProcAddr: 0x00007f8caf1663d0 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkGetInstanceProcAddr
- capability made from: 0x00007f8caf1663d0 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkGetInstanceProcAddr
- shim setting while the session was live: 0x00007f8caf1663d0 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkGetInstanceProcAddr
- GLFW resolved vkGetInstanceProcAddr to: 0x00007f8caf1663d0 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkGetInstanceProcAddr
- capability while the session was live: IntegrationInstalled
- binding vkCreateDevice: 0x00007f8caf166090 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkCreateDevice
- GLFW vkCreateDevice: 0x00007f8caf166090 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkCreateDevice
- required instance extensions, as copied: VK_KHR_surface, VK_KHR_xcb_surface
- surface creation: SurfaceCreated (WindowSurface (SurfaceObligation (AttachmentId (WindowId 1) 1) 362748192))
- surface handle: 362748192
...
- capture limits: 1024 queued records, 16384 bytes of text per record (the default is 4096; see the proof README), 16 objects per record
- main thread: OS thread 0x7f8caee9d080, ThreadId 4
...
| --- | --- | --- | --- | --- | --- |
| vkEnumerateInstanceExtensionProperties | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 0 | no |
| vkCreateInstance | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 51 | no |
| vkCreateDebugUtilsMessengerEXT | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 0 | no |
| glfwCreateWindowSurface | 0x7f8caee9d080 | yes | ThreadId 4 | 0 | no |
| vkEnumeratePhysicalDevices | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 12 | no |
| vkCreateDevice | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 13 | no |
| glfwCreateWindowSurface | 0x7f8caee9d080 | yes | ThreadId 4 | 0 | no |
| vkGetPhysicalDeviceSurfaceSupportKHR | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 0 | no |
| vkDestroySurfaceKHR | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 0 | no |
| vkDestroySurfaceKHR | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 0 | no |
| vkDestroyDevice | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 0 | no |
| vkDestroyDebugUtilsMessengerEXT | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 0 | no |
| vkDestroyInstance | 0x7f8ca6ffe6c0 | no | ThreadId 89 | 1 | no |
...
## The environment
implicit-layer policy: VK_LOADER_LAYERS_DISABLE=~implicit~, so no implicit layer joins the chain and the explicit layers below are all of it
proving repository revision 6396e9b8622122269b25dd4a04df7559ae6dca77
proving source digest f8c081769f9fc23d46216432173c579bdccaad6d0ed516d04401665ba2c6ea99
VK_DRIVER_FILES = /opt/hetoimasia/native/glfw/vulkan/share/vulkan/icd.d/lvp_icd.json
VK_LAYER_PATH = /opt/hetoimasia/native/glfw/vulkan/share/vulkan/explicit_layer.d
## The shared loader
the binding dispatches through 0x00007f8caf1663d0 in /lib/x86_64-linux-gnu/libvulkan.so.1 as vkGetInstanceProcAddr
the binding's loader is the recorded loader /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275
GLFW resolves the same name to 0x00007f8caf1663d0 in /lib/x86_64-linux-gnu/libvulkan.so.1 as vkGetInstanceProcAddr
GLFW requires VK_KHR_surface, VK_KHR_xcb_surface
## The instance
the loader reports instance version 1.3.275
the binding resolves vkCreateDevice to 0x00007f8caf166090 in /lib/x86_64-linux-gnu/libvulkan.so.1 as vkCreateDevice
GLFW resolves vkCreateDevice to 0x00007f8caf166090 in /lib/x86_64-linux-gnu/libvulkan.so.1 as vkCreateDevice
...
the binding dispatches image release through 0x00007f8c8a3f52e0 in /usr/lib/x86_64-linux-gnu/libVkLayer_khronos_validation.so
...
the capability was made from 0x00007f8caf1663d0 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkGetInstanceProcAddr
while the session is live the shim holds 0x00007f8caf1663d0 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkGetInstanceProcAddr
GLFW resolves vkGetInstanceProcAddr to 0x00007f8caf1663d0 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkGetInstanceProcAddr
the session copied the required extensions VK_KHR_surface, VK_KHR_xcb_surface
the binding resolves vkCreateDevice to 0x00007f8caf166090 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkCreateDevice
GLFW resolves vkCreateDevice to 0x00007f8caf166090 in /usr/lib/x86_64-linux-gnu/libvulkan.so.1.3.275 as vkCreateDevice
created surface 362748192 for the attached window
