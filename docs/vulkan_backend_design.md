...
|---|---|---|
| Haskell binding/toolchain | D-8/D-13 prefer the newest compatible versions including RCs. Candidates observed on 2026-09-17: GHC 9.14.2-rc2, cabal-install 3.18.1.0, `vulkan-3.27`, `vulkan-utils-0.5.11.0`; recheck availability and prove before pinning. | Use an older version only for a documented compatibility blocker; GHC 9.14.1 is the observed stable alternative. |
