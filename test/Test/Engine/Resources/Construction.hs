...
-- "Test.Engine.Resources.Journal"; the rest build small assemblies here so
...
module Test.Engine.Resources.Construction (spec) where
...
import Test.Engine.Resources.Journal
  ( JournalConfigFault (..)
  , JournalFault (..)
  , Store (..)
  , allocJournal
