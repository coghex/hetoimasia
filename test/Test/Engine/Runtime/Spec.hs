...
--
-- Application composition, the console executable's startup, and the recovery
-- and terminal-failure reporting adapter sit under the @Runtime@ group this
-- module roots, so @--match Runtime@ selects the component and nothing else.
