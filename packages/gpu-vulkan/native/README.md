...
holds VK-6's native integration and VK-9's shader adapter; VK-7 extends it with
instance, device and target ownership.
...
at the provisioned loader and headers. Its native cases run in the proof harness
until VK-8 moves them into a package-native fixture; see
